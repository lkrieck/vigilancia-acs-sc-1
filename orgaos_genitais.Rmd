---
title: Anomalias de órgãos genitais
output:
  html_document:
    toc: true
    toc_depth: 3
...
library(DT)
knitr::read_chunk('Análises de anomalias de órgãos genitais 2011.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2012.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2013.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2014.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2015.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2016.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2017.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2018.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2019.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais 2020.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais período 2011-2019.R')
knitr::read_chunk('Análises de anomalias de órgãos genitais período 2011-2020.R')
...
```{r, tab_prev.genitais.estabp1119, echo=FALSE}
```
...
```{r, tab_prev.genitais.estabp1120, echo=FALSE}
```
