...
mapa_microce.estabp1119 %>% 
  ...
  addLegendImage(mapa_microce.estabp1119, images = c("/Users/Laysa/Google Drive/Doutorado PPGBM/Análises do banco/Marcador verde.png",
...
mapa_prev.microce.muni.residp1119 %>% 
  addPolygons (weight = 0.5, fillColor = ~colormagma_prev.microce.muni.residp1119(est),
               ...
               labelOptions = labelOptions(textsize = "14px",
                                           opacity = 0.8, direction = "bottom")) %>%
  addLegend(position = "bottomleft", pal = colormagma_prev.microce.muni.residp1119, values = ~est, na.label = "Sem registro", opacity = 1, labFormat = labelFormat(big.mark = "."), title = "Prevalência/10.000")
...
mapa_prev.microce.macro.residp1119 %>% 
  addPolygons (weight = 0.5, fillColor = ~colormagma_prev.microce.macro.residp1119(est),
               ...
               <strong>Prevalência/10.000: </strong>%s", label_prev.microce.macro.residp1119$name_health_macroregion, label_prev.microce.macro.residp1119$est) %>% 
                 lapply(htmltools::HTML),
               labelOptions = labelOptions(textsize = "14px",
                                           opacity = 0.8, direction = "bottom")) %>%
  addLegend(position = "bottomleft", pal = colormagma_prev.microce.macro.residp1119, values = ~est, na.label = "Sem registro", opacity = 1, labFormat = labelFormat(big.mark = "."), title = "Prevalência/10.000")
...
mapa_prev.microce.reg.residp1119 %>% 
  addPolygons (weight = 0.5, fillColor = ~colormagma_prev.microce.reg.residp1119(est),
               ...
               labelOptions = labelOptions(textsize = "14px",
                                           opacity = 0.8, direction = "bottom")) %>%
  addLegend(position = "bottomleft", pal = colormagma_prev.microce.reg.residp1119, values = ~est, na.label = "Sem registro", opacity = 1, labFormat = labelFormat(big.mark = "."), title = "Prevalência/10.000")
...
mapa_prev.microce.muni.nascp1119 %>% 
  addPolygons (weight = 0.5, fillColor = ~colormagma_prev.microce.muni.nascp1119(est),
               ...
               labelOptions = labelOptions(textsize = "14px",
                                           opacity = 0.8, direction = "bottom")) %>%
  addLegend(position = "bottomleft", pal = colormagma_prev.microce.muni.nascp1119, values = ~est, na.label = "Sem registro", opacity = 1, labFormat = labelFormat(big.mark = "."), title = "Prevalência/10.000")
...
label_prev.microce.estabp1119 <- sprintf("<p><strong>Estabelecimento: </strong>%s<br/>
                 <strong>Prevalência/10.000: </strong>%s", label_prev.microce.estabp1119$Estabelecimento,
...
mapa_prev.microce.estabp1119 %>% 
  addMarkers(icon = ~marcadores_personalizados[as.numeric(Marcador)],
             ...
             labelOptions = labelOptions(textsize = "14px", opacity = 0.7, direction = "top"),
             options = markerOptions(riseOnHover = TRUE)) %>% 
  addLegendImage(mapa_prev.microce.estabp1119, images = c("/Users/Laysa/Google Drive/Doutorado PPGBM/Análises do banco/Marcador verde.png",
                                                         "/Users/Laysa/Google Drive/Doutorado PPGBM/Análises do banco/Marcador laranja.png",
                                                         "/Users/Laysa/Google Drive/Doutorado PPGBM/Análises do banco/Marcador vermelho.png"),
