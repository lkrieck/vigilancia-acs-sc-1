---
title: Anomalias de órgãos genitais - Hipospádias
output:
  html_document:
    toc: true
    toc_depth: 3
...
library(DT)
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2011.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2012.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2013.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2014.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2015.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2016.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2017.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2018.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2019.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia 2020.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia periodo 2011-2019.R")
knitr::read_chunk("Análises de anomalias de órgãos genitais hipospadia periodo 2011-2020.R")
